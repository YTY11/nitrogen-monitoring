<template>
  <div class="monitoring-total">
    <div class="monitoring-total-title">监控总数：300台</div>
    <div class="monitoring">
      <MonitoringTotalItem v-for=""/>
    </div>
  </div>
</template>
...
import green from '@/assets/img/monitoringTotal/grey.png'
import green from '@/assets/img/monitoringTotal/red.png'
export default {
