<template>
  <div class="select">
    <div class="floor-select">
      ...
      <input type="text" class="select-input" readonly placeholder="请选择" @click="isShowFloorList"/>
    ...
    <div class="line-select div-margin">
      ...
      <input v-show="v-show="isFloorShow"" type="text" class="select-input" readonly placeholder="请选择" />
      <ul class="floor-ul line-ul">
        <li>ss</li>
        <li>ss</li>
        <li>ss</li>
      </ul>
