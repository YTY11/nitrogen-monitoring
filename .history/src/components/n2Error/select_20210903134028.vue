<template>
  <div class="select">
    <div class="floor-select">
      ...
      <input type="text" class="select-input" ref="floor" readonly placeholder="请选择" @click="isShowFloorList"/>
      <ul v-show="isFloorShow" class="floor-ul">
        <li @click="activeFloor('ss')">ss</li>
        <li>ss</li>
        <li>ss</li>
      </ul>
    </div>
    <div class="line-select div-margin">
      <span>线体:</span>
      <i @click="isShowLneList"></i>
      <input  type="text" class="select-input" ref="line" readonly placeholder="请选择" @click="isShowLineList"/>
      <ul v-show="isLineShow" class="floor-ul line-ul">
        <li @click="activeLine('ss')">ss</li>
        <li>ss</li>
        <li>ss</li>
      </ul>
    </div>
