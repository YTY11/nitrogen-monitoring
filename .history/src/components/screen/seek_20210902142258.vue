<template>
  <div class="seek">
    <div class="seek-div" v-for="(items,index) in lists" :key="index">
      <input type="text" readonly="" placeholder="楼层" @click="showFloor" />
      <ul v-show="isShowFloor" v-for="(item,id) in items" :key="id">
        <li>ss</li>
        <li>ss</li>
      </ul>
    </div>
