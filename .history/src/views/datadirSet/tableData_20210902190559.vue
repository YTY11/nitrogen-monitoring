  ...
  <div class="table-data">
    <table>
      ...
      <tbody>
        ...
        <td>
          <s  type="button" class="layui-btn layui-btn-sm layui-btn-normal" @click="change(index,item.Floor,item.LineName,item.MachineId,item.msg)" style="width: 60px;">{{item.msg}}</s>
        </td>
