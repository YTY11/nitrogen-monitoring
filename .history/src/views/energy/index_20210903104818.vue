  ...
  <el-container>
    ...
    <el-header class="n2-electronic-header">
      <N2Header>
        ...
        <Seek style="margin-left:.08rem" slot="center" :Floors="Floors" :Lines="LineNames" @seek="seek" />
      </N2Header>
    </el-header>
    <!-- 主体内容 -->
    <el-main class="n2-electronic-main">
      ...
      <Underly class="underly-center" title="楼层氮气消耗排名">
        ...
        />
        <MonochromeBarColors
          style="margin-top: 0.08rem"
          :xDatas="n2EnergyLineNames"
          :yDatas="n2EnergyLineConsume"
          class="bar-size2"
        />
      </Underly>
...
export default {
  ...
  created() {
    ...
    this.getByWeekPcsData(this.floor, this.line);
    this.getByMonthPcsData(this.floor, this.line);
