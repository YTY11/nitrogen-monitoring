  ...
  <el-container>
    ...
    <el-main class="n2-electronic-main">
      ...
      <ErrorUnderly class="bottom-underly" underlyTitle="当月异常原因排行">
        <MonochromeBar xDatas="['流量超标','低于设置下限']" :yDatas="dataList.SumNow" slot="center" class="bar-size" />
    ...
    getErrorAnalysis(time){
      getErrorAnalysis(time).then(res=>{
        ...
        if(res.Status == "0"){  
          ...
          this.tableList2.push([this.dataList.AbnormalUpNow[0],this.dataList.AbnormalDownNow[0]])
