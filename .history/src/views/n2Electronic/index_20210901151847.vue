  ...
  <el-container>
    ...
    <el-main class="n2-electronic-main">
      <MonitoringTotal
        ...
        :detailMessageItemList="detailMessageItemList"
      />
      <Underly title="异常楼层排行">
        <MonochromeBar
          class="err-floor"
          :xDatas="detailMessageByFloor.Floor"
          :yDatas="detailMessageByFloor.Abnormal"
        />
        <UnderlyTable :newFloorList="newFloorList" />
      </Underly>
      ...
      jianKongAllData()
        .then((resolve) => {
          if (resolve.Status == 0) {
            ...
            this.detailMessageItemList.push(
              this.detailMessage.AllNormal,
              this.detailMessage.AllAbnormal,
              this.detailMessage.AllOffline
            );
            ...
            this.newFloorList = errFloorList;
          }
        })
        .catch((err) => {
          console.log(err);
